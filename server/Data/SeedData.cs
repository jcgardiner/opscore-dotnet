...
namespace server.Data
{
    public static class SeedData
    {
        public static async Task InitializeAsync(AppDbContext context)
        {
            ...
            {
                new Incident { Title = "Minor oil leak detected", Description = "Small oil leak found at base of Pump Jack Unit 7", Severity = "Medium", Status = "Open", OccurredDate = new DateTime(2026, 3, 30, 0, 0, 0, DateTimeKind.Utc), SiteId = sites[0].SiteId, ReportedById = personnel[0].PersonnelId, CreatedDate = new DateTime(2026, 3, 30, 0, 0, 0, DateTimeKind.Utc) },
                new Incident { Title = "Hydraulic system failure", Description = "Complete hydraulic failure on Pump Jack Unit 12 during operation", Severity = "High", Status = "UnderReview", OccurredDate = new DateTime(2026, 3, 28, 0, 0, 0, DateTimeKind.Utc), SiteId = sites[0].SiteId, ReportedById = personnel[1].PersonnelId, CreatedDate = new DateTime(2026, 3, 28, 0, 0, 0, DateTimeKind.Utc) },
                new Incident { Title = "Perimeter breach alert", Description = "Unauthorized vehicle detected near north perimeter", Severity = "Critical", Status = "Resolved", OccurredDate = new DateTime(2026, 3, 19, 0, 0, 0, DateTimeKind.Utc), ResolvedDate = new DateTime(2026, 3, 21, 0, 0, 0, DateTimeKind.Utc), SiteId = sites[2].SiteId, ReportedById = personnel[3].PersonnelId, CreatedDate = new DateTime(2026, 3, 19, 0, 0, 0, DateTimeKind.Utc) },
                new Incident { Title = "Equipment malfunction during exercise", Description = "Generator failure caused temporary power loss during training exercise", Severity = "Medium", Status = "Resolved", OccurredDate = new DateTime(2026, 3, 25, 0, 0, 0, DateTimeKind.Utc), ResolvedDate = new DateTime(2026, 3, 26, 0, 0, 0, DateTimeKind.Utc), SiteId = sites[2].SiteId, ReportedById = personnel[4].PersonnelId, CreatedDate = new DateTime(2026, 3, 25, 0, 0, 0, DateTimeKind.Utc) },
                new Incident { Title = "Road grader collision", Description = "Road grader made contact with utility pole during operation", Severity = "High", Status = "UnderReview", OccurredDate = new DateTime(2026, 4, 1, 0, 0, 0, DateTimeKind.Utc), SiteId = sites[4].SiteId, ReportedById = personnel[6].PersonnelId, CreatedDate = new DateTime(2026, 4, 1, 0, 0, 0, DateTimeKind.Utc) },
                new Incident { Title = "Chemical spill containment", Description = "Minor chemical spill contained at water treatment facility", Severity = "Medium", Status = "Resolved", OccurredDate = new DateTime(2026, 3, 13, 0, 0, 0, DateTimeKind.Utc), ResolvedDate = new DateTime(2026, 3, 14, 0, 0, 0, DateTimeKind.Utc), SiteId = sites[4].SiteId, ReportedById = personnel[7].PersonnelId, CreatedDate = new DateTime(2026, 3, 13, 0, 0, 0, DateTimeKind.Utc) },
                new Incident { Title = "Gas pressure anomaly", Description = "Abnormal pressure readings on separator unit during night shift", Severity = "High", Status = "Open", OccurredDate = new DateTime(2026, 4, 2, 0, 0, 0, DateTimeKind.Utc), SiteId = sites[6].SiteId, ReportedById = personnel[9].PersonnelId, CreatedDate = new DateTime(2026, 4, 2, 0, 0, 0, DateTimeKind.Utc) }
            };
